...
<head>
  ...
  <title>Control Center | نظام الطلبيات</title>
  ...
  <style>
    ...
    * { box-sizing: border-box; }
    ...
    body {
      ...
      overflow-x: hidden;
      background:
        radial-gradient(circle at 88% 7%, rgba(9, 153, 153, .24), transparent 30%),
        radial-gradient(circle at 9% 17%, rgba(199, 146, 43, .18), transparent 26%),
        radial-gradient(circle at 52% 2%, rgba(79, 70, 229, .13), transparent 31%),
        linear-gradient(135deg, #f8fbfb 0%, #eef8f8 42%, #f7fafc 100%);
    ...
    @keyframes orbit {
      ...
      to { transform: translate3d(32px, 36px, 0) scale(1.08); }
    }
    ...
    .hero {
      ...
      background:
        ...
        radial-gradient(circle at 22% 10%, rgba(9,153,153,.16), transparent 28%);
    }
    ...
    .hero::before {
      ...
      inset: -2px;
      background:
        linear-gradient(110deg, transparent 0%, rgba(255,255,255,.85) 38%, transparent 54%),
        radial-gradient(circle at 84% 30%, rgba(9,153,153,.22), transparent 24%);
    ...
    @keyframes sheen {
      0%, 42% { transform: translateX(58%); }
      72%, 100% { transform: translateX(-58%); }
    }

    .hero-content { position: relative; z-index: 1; display: grid; align-content: center; }
    ...
    .eyebrow {
      ...
      margin-bottom: 14px;
      border-radius: 999px;
      background: rgba(9, 153, 153, .11);
      border: 1px solid rgba(9, 153, 153, .20);
      color: var(--teal-deep);
      font-size: 12px;
      font-weight: 900;
    }
    ...
    @keyframes pulse {
      0% { box-shadow: 0 0 0 0 rgba(9,153,153,.48); }
      70% { box-shadow: 0 0 0 12px rgba(9,153,153,0); }
    ...
    .royal-card {
      ...
      color: #fff;
      background:
        radial-gradient(circle at 18% 18%, rgba(18,199,199,.34), transparent 32%),
        linear-gradient(145deg, #07111f, #0b2a38 52%, #057979);
    ...
    .royal-card small,
    .live-card span { color: rgba(255,255,255,.68); font-weight: 800; }
    ...
    .royal-card p { margin: 5px 0 0; color: rgba(255,255,255,.78); font-weight: 700; }
    ...
    .live-card::before {
      ...
      position: absolute;
      inset: 0;
      background: linear-gradient(90deg, rgba(9,153,153,.18), transparent 55%);
      pointer-events: none;
    }

    .live-value { font-family: var(--font-num); font-size: 17px; font-weight: 900; position: relative; z-index: 1; }
    ...
    .btn {
      ...
      box-shadow: 0 14px 32px rgba(9, 153, 153, .18);
      transition: transform .18s ease, box-shadow .18s ease, opacity .18s ease;
      white-space: nowrap;
      user-select: none;
    }

    .btn:hover { transform: translateY(-2px); box-shadow: 0 18px 44px rgba(9,153,153,.24); }
    ...
    .btn.danger { background: linear-gradient(135deg, #7f1d1d, #b42318); }
    .btn.gold { background: linear-gradient(135deg, #7c5515, #c7922b); }
    ...
    .nav-pill.active {
      ...
      border-color: rgba(9,153,153,.35);
    }
    ...
    .section-title h2 { margin: 0; color: var(--navy); font-size: clamp(20px, 2.2vw, 30px); }
    .section-title p { margin: 0; color: var(--muted); font-weight: 700; line-height: 1.7; }
    ...
    .field textarea { min-height: 90px; resize: vertical; line-height: 1.8; }

    .field input:focus,
    .field select:focus,
    .field textarea:focus {
      border-color: rgba(9,153,153,.64);
      box-shadow: 0 0 0 4px rgba(9,153,153,.10);
    ...
    .status-card:hover {
      ...
      border-color: rgba(9,153,153,.38);
      background: rgba(255,255,255,.95);
    }

    .queue-card span,
    .status-card span { display: block; color: var(--muted); font-size: 12px; font-weight: 900; }
    .queue-card strong,
    .status-card strong { display: block; margin-top: 10px; color: var(--navy); font-family: var(--font-num); font-size: 30px; font-weight: 900; }
    .queue-card small,
    .status-card small { display: block; margin-top: 7px; color: var(--muted-2); font-weight: 800; line-height: 1.5; }
    ...
    .command-meta { display: flex; align-items: center; gap: 9px; flex-wrap: wrap; color: rgba(255,255,255,.76); font-weight: 800; }
    ...
    .badge.dark { background: rgba(255,255,255,.10); border-color: rgba(255,255,255,.16); color: #fff; }
    ...
    .badge.neutral { color: #334155; background: #f8fafc; border-color: #e2e8f0; }
    ...
    tbody tr:hover { background: rgba(9,153,153,.052); }

    .check-cell { width: 42px; text-align: center; }
    .order-check { width: 18px; height: 18px; accent-color: var(--teal); }
    ...
    .pharmacy-cell { display: grid; gap: 4px; min-width: 260px; }
    .pharmacy-cell strong { color: var(--navy); font-weight: 900; overflow: hidden; text-overflow: ellipsis; max-width: 320px; }
    .pharmacy-cell small { color: var(--muted); font-weight: 800; }

    .money { direction: ltr; font-family: var(--font-num); font-weight: 900; color: var(--navy); }
    ...
    .mini-btn:hover { transform: translateY(-1px); background: rgba(9,153,153,.14); }
    .mini-btn.dark { color: #fff; background: linear-gradient(135deg, var(--navy), var(--teal)); }
    .mini-btn.gold { color: #6b460d; background: #fffbeb; border-color: #fde68a; }
    ...
    .drawer {
      ...
      animation: drawerIn .28s cubic-bezier(.2,.8,.2,1) both;
    }
    ...
    .drawer-head {
      ...
      gap: 12px;
      background:
        radial-gradient(circle at 92% 5%, rgba(9,153,153,.14), transparent 25%),
        linear-gradient(135deg, #ffffff, #f8fafc);
      border-bottom: 1px solid #e2e8f0;
    }

    .drawer-title { display: grid; gap: 5px; }
    .drawer-title h2 { margin: 0; color: var(--navy); font-size: clamp(20px, 2.5vw, 32px); }
    .drawer-title p { margin: 0; color: var(--muted); font-weight: 800; line-height: 1.7; }
    ...
    .info-box span { color: var(--muted); font-size: 12px; font-weight: 900; }
    .info-box strong { color: var(--navy); font-size: 15px; line-height: 1.65; overflow-wrap: anywhere; }
    ...
    .step.current { background: #effafa; border-color: rgba(9,153,153,.35); box-shadow: 0 0 0 4px rgba(9,153,153,.08); }
    .step.rejected { background: #fef2f2; border-color: #fecaca; }
    .step.deleted { background: #f1f5f9; border-color: #cbd5e1; }
    .step span { display: block; color: var(--muted); font-size: 11px; font-weight: 900; }
    .step strong { display: block; margin-top: 8px; color: var(--navy); font-size: 13px; line-height: 1.6; }
    ...
    .audit-entry p { margin: 0; color: var(--muted); font-weight: 800; line-height: 1.8; }

    .mini-table-wrap { overflow: auto; }
    .mini-table { min-width: 780px; }
    .mini-table th, .mini-table td { padding: 10px; }
    ...
    .modal-head p { margin: 5px 0 0; color: var(--muted); font-weight: 800; line-height: 1.7; }
    ...
    .toast.success { background: rgba(6, 95, 70, .96); }
    .toast.warning { background: rgba(146, 64, 14, .96); }
    ...
    @media (max-width: 1180px) {
      ...
      .hero-side { min-width: 0; grid-template-columns: repeat(2, minmax(0, 1fr)); }
      .filters { grid-template-columns: repeat(3, minmax(0, 1fr)); }
      .kpi-grid { grid-template-columns: repeat(3, minmax(0, 1fr)); }
      .dashboard-grid { grid-template-columns: 1fr; }
      .flow-board { grid-template-columns: repeat(3, minmax(0, 1fr)); }
      .status-cloud { grid-template-columns: repeat(2, minmax(0, 1fr)); max-height: none; }
      .detail-grid { grid-template-columns: repeat(2, minmax(0, 1fr)); }
    }

    @media (max-width: 760px) {
      body { padding: 10px; }
      .hero { border-radius: 26px; min-height: auto; }
      .hero-side { grid-template-columns: 1fr; }
      .nav-strip { grid-template-columns: repeat(2, minmax(0, 1fr)); }
      .nav-pill { min-height: 64px; padding: 12px; }
      .filters { grid-template-columns: 1fr; }
      .wide-2 { grid-column: auto; }
      .kpi-grid { grid-template-columns: repeat(2, minmax(0, 1fr)); }
      .flow-board,
      .status-cloud,
      .timeline { grid-template-columns: 1fr; }
      .command-bar { align-items: stretch; }
      .command-meta, .command-actions { width: 100%; }
      ...
      .mobile-order-card .top { display: flex; justify-content: space-between; gap: 10px; align-items: start; }
      .mobile-order-card h3 { margin: 0; color: var(--navy); font-size: 15px; line-height: 1.6; }
      .mobile-order-card p { margin: 0; color: var(--muted); font-weight: 800; line-height: 1.7; }
      .drawer-overlay { padding: 0; }
      .drawer { width: 100%; border-radius: 0; min-height: 100dvh; }
...
<body class="admin-embedded">
    ...
    <section class="hero glass" id="top">
      ...
      <aside class="hero-side">
        <div class="royal-card">
          <small>قيمة المعروض الآن</small>
          <strong id="heroValue">0.00</strong>
          <p>دينار أردني حسب الفلاتر النشطة.</p>
        </div>
        <div class="live-card">
          <span>آخر تحميل</span>
          <div class="live-value" id="lastLoadedAt">لم يتم التحميل بعد</div>
          <span id="connectionHint">متصل بـ Firebase مباشرة</span>
        </div>
      </aside>
    </section>

    <nav class="nav-strip" aria-label="Quick navigation">
      <button class="nav-pill active" type="button" data-scroll-target="dashboardSection"><i class="ph ph-gauge"></i><span>لوحة القيادة</span></button>
      <button class="nav-pill" type="button" data-scroll-target="ordersSection"><i class="ph ph-table"></i><span>الطلبيات</span></button>
      <button class="nav-pill" type="button" data-scroll-target="flowSection"><i class="ph ph-git-branch"></i><span>المسارات</span></button>
      <button class="nav-pill" type="button" data-scroll-target="ordersSection"><i class="ph ph-magic-wand"></i><span>الأوامر</span></button>
    </nav>

    <section class="filters glass" aria-label="Filters">
      <div class="field">
        <label for="dateFrom"><i class="ph ph-calendar"></i> من تاريخ</label>
        <input id="dateFrom" type="date" />
      </div>
      <div class="field">
        <label for="dateTo"><i class="ph ph-calendar-check"></i> إلى تاريخ</label>
        <input id="dateTo" type="date" />
      </div>
      <div class="field wide-2">
        <label for="searchBox"><i class="ph ph-magnifying-glass"></i> بحث ذكي</label>
        <input id="searchBox" type="search" placeholder="رقم الطلبية / الصيدلية / كود الصيدلية / المندوب / الملاحظة" autocomplete="off" />
      </div>
      <div class="field">
        <label for="statusFilter"><i class="ph ph-seal-check"></i> الحالة</label>
        <select id="statusFilter"><option value="">كل الحالات</option></select>
      </div>
      <div class="field">
        <label for="ownerFilter"><i class="ph ph-user-focus"></i> المطلوب من</label>
        <select id="ownerFilter">
          ...
          <option value="none">مغلق / لا يوجد</option>
        </select>
      </div>
      <div class="field wide-2">
        <label for="pharmacySearch"><i class="ph ph-storefront"></i> الصيدلية</label>
        <input id="pharmacySearch" type="search" placeholder="اكتب اسم الصيدلية أو الكود — الكتابة تكفي" autocomplete="off" />
      </div>
      <div class="field">
        <label for="historyFilter"><i class="ph ph-clock-counter-clockwise"></i> السجلات</label>
        <select id="historyFilter">
          <option value="">كل السجلات</option>
          <option value="audit">لديها سجل تدقيق</option>
          <option value="export">لديها سجل تصدير</option>
          <option value="print">لديها سجل طباعة</option>
          <option value="no_audit">بدون سجل تدقيق</option>
        </select>
      </div>
      <div class="field">
        <label for="sortMode"><i class="ph ph-sort-descending"></i> الترتيب</label>
        <select id="sortMode">
      ...
      <div class="field">
        <label>&nbsp;</label>
        <button class="btn secondary" type="button" id="resetFiltersBtn"><i class="ph ph-funnel-x"></i> إعادة ضبط</button>
      </div>
    </section>
    ...
    <section class="section" id="dashboardSection">
      <div class="section-head">
        <div class="section-title">
          ...
          <p>قراءة فورية لأثر الفلاتر على عدد الطلبيات، القيمة، السجلات، وجهات المتابعة.</p>
        </div>
        <span class="badge" id="visibleSummary">0 طلبية ظاهرة</span>
      </div>
      <div class="kpi-grid">
        <div class="kpi-card"><div class="icon"><i class="ph ph-package"></i></div><span>إجمالي الطلبيات</span><strong id="kpiOrders">0</strong></div>
        <div class="kpi-card"><div class="icon"><i class="ph ph-coins"></i></div><span>إجمالي القيمة</span><strong id="kpiValue">0.00</strong></div>
        <div class="kpi-card"><div class="icon"><i class="ph ph-chart-line-up"></i></div><span>متوسط الطلبية</span><strong id="kpiAvg">0.00</strong></div>
        <div class="kpi-card"><div class="icon"><i class="ph ph-clock-counter-clockwise"></i></div><span>حركات التدقيق</span><strong id="kpiAudit">0</strong></div>
        <div class="kpi-card"><div class="icon"><i class="ph ph-file-arrow-down"></i></div><span>سجلات التصدير</span><strong id="kpiExport">0</strong></div>
        <div class="kpi-card"><div class="icon"><i class="ph ph-printer"></i></div><span>سجلات الطباعة</span><strong id="kpiPrint">0</strong></div>
      </div>
    </section>

    <section class="dashboard-grid section" id="flowSection">
      <div class="panel glass">
        <div class="section-head">
          <div class="section-title">
            <h2>خريطة المطلوب منه الآن</h2>
            <p>اضغط على أي بطاقة لتطبيق فلتر الجهة مباشرة.</p>
          </div>
        </div>
        <div class="flow-board" id="ownerBoard"></div>
      </div>
      <div class="panel glass">
        <div class="section-head">
          <div class="section-title">
            <h2>الحالات الحية</h2>
            <p>تجميع حسب آخر حالة فعلية لكل طلبية.</p>
          </div>
        </div>
        <div class="status-cloud" id="statusCloud"></div>
      </div>
    </section>
    ...
    <section class="section" id="ordersSection">
      <div class="command-bar">
        <div class="command-meta">
          <span class="badge dark"><i class="ph ph-check-square"></i> المحدد: <b id="selectedCount">0</b></span>
          <span class="badge dark"><i class="ph ph-database"></i> إجمالي قاعدة البيانات: <b id="databaseCount">0</b></span>
          <span class="badge dark" id="loadingState"><i class="ph ph-circle-notch"></i> جاهز</span>
        </div>
        <div class="command-actions">
          <button class="btn gold" type="button" id="bulkStatusBtn" disabled><i class="ph ph-git-branch"></i> تغيير حالة المحدد</button>
          <button class="btn secondary" type="button" id="exportBtn"><i class="ph ph-file-xls"></i> Excel</button>
          <button class="btn secondary" type="button" id="refreshBtn"><i class="ph ph-arrow-clockwise"></i> تحديث</button>
        </div>
      </div>
      ...
      <div class="table-card glass">
        <div class="table-scroll">
          <table class="orders-table">
            <thead>
              <tr>
                <th class="check-cell"><input class="order-check" id="selectAllVisible" type="checkbox" aria-label="تحديد كل المعروض" /></th>
                <th>رقم الطلبية</th>
                <th>التاريخ</th>
                <th>الوقت</th>
                <th>الصيدلية</th>
            ...
            <tbody id="ordersBody">
              <tr><td colspan="11"><div class="empty-state"><span class="skeleton" style="width: 70%;"></span></div></td></tr>
            </tbody>
          </table>
        </div>
  ...
  <div class="drawer-overlay" id="detailsOverlay" aria-hidden="true">
    <aside class="drawer" role="dialog" aria-modal="true" aria-labelledby="detailsTitle">
      <header class="drawer-head">
        <div class="drawer-title">
          <h2 id="detailsTitle">تفاصيل الطلبية</h2>
          <p id="detailsSubtitle">—</p>
          <div class="hero-actions" id="drawerActions"></div>
        </div>
        <button class="close-btn" type="button" id="closeDetailsBtn" aria-label="إغلاق"><i class="ph ph-x"></i></button>
      </header>
  ...
  <div class="modal-overlay" id="statusModal" aria-hidden="true">
    <div class="modal-box" role="dialog" aria-modal="true" aria-labelledby="statusModalTitle">
      <div class="modal-head">
        <div>
          <h2 id="statusModalTitle">تغيير حالة الطلبية</h2>
          <p id="statusModalSubtitle">اختر الحالة الجديدة واكتب ملاحظة واضحة. الملاحظة إجبارية لحماية سجل التدقيق.</p>
        </div>
        <button class="close-btn" type="button" id="closeStatusModalBtn" aria-label="إغلاق"><i class="ph ph-x"></i></button>
      </div>
      <div class="field">
        <label for="targetStatus"><i class="ph ph-git-branch"></i> الحالة الجديدة</label>
        <select id="targetStatus"></select>
      </div>
      <div class="field" style="margin-top: 12px;">
        <label for="statusNote"><i class="ph ph-note-pencil"></i> ملاحظة إجبارية</label>
        <textarea id="statusNote" placeholder="اكتب سبب التغيير بوضوح"></textarea>
      </div>
      <div class="modal-actions">
        <button class="btn secondary" type="button" id="cancelStatusBtn">إلغاء</button>
        <button class="btn" type="button" id="confirmStatusBtn"><i class="ph ph-check-circle"></i> تأكيد التغيير</button>
      </div>
    </div>
  </div>
  ...
  <script type="module">
    ...
    function getOrderTotal(order = {}) {
      const direct = parseNumber(order.grandTotal ?? order.total ?? order.totalValue ?? order.netTotal ?? order.orderTotal ?? order.value ?? 0);
    ...
    function latestStatusFromLogs(order = {}) {
      ...
      collections.flat().forEach(entry => {
        ...
        if (!status) return;
        const time = logEntryDate(entry)?.getTime() || 0;
    ...
    function exportCount(order = {}) {
      return arrayCount(order.exportHistory) + (order.exportedAt ? 1 : 0);
    }

    function printCount(order = {}) {
    ...
    function enrichOrder(order = {}) {
      ...
      const pharmacyName = getPharmacyName(order);
      const pharmacyCode = getPharmacyCode(order);
      const repName = getRepName(order);
      const note = getOrderNote(order);
      const total = getOrderTotal(order);
      return {
        ...order,
        __status: status,
        __statusLabel: statusLabel(status),
        __ownerKey: follow.ownerKey,
        __owner: follow.owner,
        __ownerDetail: follow.detail,
        __date: date,
        __dateTs: date?.getTime() || 0,
        __pharmacyName: pharmacyName,
        __pharmacyCode: pharmacyCode,
        __repName: repName,
        __note: note,
        __total: total,
    ...
    function applyFilters() {
      ...
      state.visible = state.orders.filter(order => {
        ...
        const pharmacyMatch = !pharmacyWords.length || pharmacyWords.every(word => order.__pharmacySearch.includes(word));
        const statusMatch = !status || order.__status === status;
        const ownerMatch = !owner || order.__ownerKey === owner;
        return textMatch && pharmacyMatch && statusMatch && ownerMatch && inDateRange(order) && historyMatches(order);
      });
    ...
    function renderKpis() {
      ...
      const total = state.visible.reduce((sum, order) => sum + order.__total, 0);
    ...
    async function applyStatusPatch(orderIds, targetStatus, note) {
    ...
    function isHistoricalOrdersRange(range) {
      ...
      return range.toDate.getTime() < currentMonthStart.getTime();
    }

    function ordersCacheTtl(range) {
      return isHistoricalOrdersRange(range) ? HISTORICAL_ORDERS_CACHE_TTL_MS : ORDERS_CACHE_TTL_MS;
    }


    function readOrdersCache(range, allowExpired = false) {
      try {
        const raw = localStorage.getItem(ordersCacheKey(range));
        if (!raw) return null;
    ...
    function writeOrdersCache(range, orders) {
      try {
        localStorage.setItem(ordersCacheKey(range), JSON.stringify({
          savedAt: Date.now(),
          orders
        }));
      } catch (error) {
    ...
    function hydrateOrders(rawOrders = []) {
      state.orders = rawOrders.map(order => enrichOrder(order));
      state.orders.sort((a, b) => b.__dateTs - a.__dateTs);
      buildStatusOptions();
      applyFilters();
    }
    ...
    async function loadOrders(quiet = false, forceRemote = false) {
      if (state.loadingPromise) return state.loadingPromise;
      const range = selectedOrdersRange();
      const cachedOrders = readOrdersCache(range, false);
    ...
    function pruneSelection() {
      const visibleIds = new Set(state.visible.map(order => order.id));
    ...
    function toggleSelectAll(checked) {
      state.visible.forEach(order => {
        if (checked) state.selected.add(order.id);
