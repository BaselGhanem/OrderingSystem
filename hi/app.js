...
function setAuthenticatedView(isAuthenticated) {
    ...
    document.body.classList.toggle(`app-login-gate`, !isAuthenticated);
    document.body.classList.toggle(`app-authenticated`, !!isAuthenticated);
}

function forceLoginOnlyView() {
    setAuthenticatedView(false);
    [`orderScreen`, `myOrdersScreen`, `reportsScreen`, `managerScreen`].forEach(id => {
    ...
    if (loginScreen) {
        ...
        loginScreen.classList.remove(`pharmacy-switch-mode`);
    }
